...
(1, 10, 'PPA1', 'Pilates','Una actividad para relajarse un rato',10,5, '2025-04-11', '11:05'),
(2, 5,'PPIS','Waterpolo','El gorro no se proporciona',15,10, '2025-04-12', '9:30'),
(3, 6, 'PPE1','Atletismo',' ',4,2, '2025-04-261', '13:00');
...
select * from actividades a , inscrito_en i where a.id_actividad =i.id_act;
